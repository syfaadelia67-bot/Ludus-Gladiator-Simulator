...
func _initialize() -> void:
	...
	assert(market_text.contains("var last_auto_refresh_week: int:"))
	assert(market_text.contains("return last_auto_refresh_month"))
	...
	print("Market month-native cover navigation and purchase stability contract: OK")
	quit()
