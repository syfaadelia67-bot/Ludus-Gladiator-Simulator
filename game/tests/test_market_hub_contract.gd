...
func _initialize() -> void:
	...
	assert(screen_text.contains("RENOVACIÓN MANUAL NO DISPONIBLE"))
	assert(screen_text.contains("equipamiento se obtiene mediante la Forja"))
	assert(not screen_text.contains("MarketManager.refresh_equipment_market(true)"))
