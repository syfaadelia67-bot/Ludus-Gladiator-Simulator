...
func _enter_tree() -> void:
	error_label_settings = preload("res://addons/scalable_vector_shapes_2d/error_label_settings.tres")
	warning_label_settings = preload("res://addons/scalable_vector_shapes_2d/warn_label_settings.tres")
	info_label_settings = preload("res://addons/scalable_vector_shapes_2d/info_label_settings.tres")
	debug_label_settings = preload("res://addons/scalable_vector_shapes_2d/debug_label_settings.tres")
	LinkButtonScene = preload("res://addons/scalable_vector_shapes_2d/link_button_with_copy_hint.tscn")
	...
	if style.has("stroke") and style["stroke"] != "none":
		...
		if stroke is Line2D:
			...
			if CurvedLines2D._use_antialiased_line_2d():
				stroke.texture = load("res://addons/scalable_vector_shapes_2d/LumAlpha8.tex")
