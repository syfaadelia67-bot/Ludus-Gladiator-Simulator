...
var LineCapEditor = preload("res://addons/scalable_vector_shapes_2d/line_cap_editor_property.gd")
var LineJointModeEditor = preload("res://addons/scalable_vector_shapes_2d/line_joint_editor_property.gd")
...
func _parse_group(object: Object, group: String) -> void:
	if group == GROUP_NAME_CURVE_SETTINGS and object is ScalableVectorShape2D:
		var key_frame_form = load("res://addons/scalable_vector_shapes_2d/batch_insert_curve_point_key_frames_inspector_form.tscn").instantiate()
...
func _parse_property(object: Object, type: Variant.Type, name: String, hint_type: PropertyHint, hint_string: String, usage_flags: int, wide: bool) -> bool:
	if name == "line" and (object is  ScalableVectorShape2D):
		var assign_stroke_inspector_form = load("res://addons/scalable_vector_shapes_2d/assign_stroke_inspector_form.tscn").instantiate()
		...
		var assign_fill_inspector_form = load("res://addons/scalable_vector_shapes_2d/assign_fill_inspector_form.tscn").instantiate()
		...
		add_custom_control(assign_fill_inspector_form)
			...
			#return true
		var assign_collision_inspector_form = load("res://addons/scalable_vector_shapes_2d/assign_collision_inspector_form.tscn").instantiate()
		...
		var assign_collision_inspector_form = load("res://addons/scalable_vector_shapes_2d/assign_collision_object_inspector_form.tscn").instantiate()
		assign_collision_inspector_form.scalable_vector_shape_2d = object
		add_custom_control(assign_collision_inspector_form)
	elif name == "path" and (object is ScalableVectorShape2D):
		var assign_path_inspector_form = load("res://addons/scalable_vector_shapes_2d/assign_path_inspector_form.tscn").instantiate()
		assign_path_inspector_form.scalable_vector_shape_2d = object
		add_custom_control(assign_path_inspector_form)
	elif name == "navigation_region" and (object is ScalableVectorShape2D):
		var assign_nav_form = load("res://addons/scalable_vector_shapes_2d/assign_navigation_region_inspector_form.tscn").instantiate()
