...
var stylebox : StyleBoxFlat = preload("res://addons/scalable_vector_shapes_2d/external_video_button.stylebox")
var stylebox_hover : StyleBoxFlat = preload("res://addons/scalable_vector_shapes_2d/external_video_button_hover.stylebox")
