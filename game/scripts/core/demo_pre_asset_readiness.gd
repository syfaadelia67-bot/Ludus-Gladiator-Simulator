...
const PENDING_AUTHORITY_BOUNDARIES := {
	...
	"Six-slot inventory, equip and Save v14 authority are canonical; final catalog breadth, crafting costs, quality and Combat V1 item power/defense remain pending.",
